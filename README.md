...
* Desenvolvimento de aplicações web modernas (React + TypeScript + I.A)
* Criação de produtos escaláveis com Supabase
* Integração com APIs e soluções de I.A
...
* Aplicação full stack com React + Supabase
...
* Desenvolvido com foco em Agilizar processos de Vistoria
* Permitir fazer comparativos de fotos de vistoria de entrada/saida
* Ferramentas para produtividade
  * Futuras Implementação de I.A para analise e geração de relatorios automáticos
